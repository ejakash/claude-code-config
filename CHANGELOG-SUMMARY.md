...
Index of all changes. `[core]` entries are already folded into SETUP-GUIDE.md — the agent strongly recommends applying them on every machine. `[optional]` entries are presented per-machine for the user to accept or skip.
