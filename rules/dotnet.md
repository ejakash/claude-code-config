...
`jb` is available via Windows interop at `/mnt/c/Users/<WINDOWS_USER>/.dotnet/tools/jb.exe`. Use this path directly or add to PATH: <!-- edit per machine: Windows username (throughout this file) -->

```bash
export PATH="$PATH:/mnt/c/Users/<WINDOWS_USER>/.dotnet/tools"
```

Some projects ship a project-level `/inspect` command that wraps this — prefer it where it exists.
...
```
/mnt/c/Users/<WINDOWS_USER>/.dotnet/tools/jb.exe inspectcode -o="inspect-results.json" -f="Sarif" -e="WARNING" <solution-file>
```
...
```
/mnt/c/Users/<WINDOWS_USER>/.dotnet/tools/jb.exe cleanupcode <solution-file> --include="**/ChangedFile.cs"
```
