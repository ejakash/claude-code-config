...
1. If `~/.claude/settings.json` does not exist: copy this module's `settings.json` after substituting `<LINUX_USER>` with your WSL username (sed `s|<LINUX_USER>|<LINUX_USER>|g`).
